...
| `npm run validate:phase11` | Test + lint + typecheck + build (Phase 11 gate) |
...
**Manual (polish/a11y):** dark mode, keyboard flow, reduced motion, and mobile behavior checks are documented in [phase-status.md](./phase-status.md).
