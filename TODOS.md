...
- Phase 4 — Recurrence
- Phase 5 — VooV integration
- Phase 6 — Session lifecycle
- Phase 7 — Dashboard widgets
- Phase 8 — Reminders
- Phase 9 — Working hours + blackouts
- Phase 10 — iCal + CSV
...
- Theme foundation: light/dark design tokens and class strategy
- Theme toggle UI + persisted preference
- Theme QA across all current pages/components
